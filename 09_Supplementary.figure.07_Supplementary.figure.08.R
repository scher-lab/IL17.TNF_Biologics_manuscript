...
### Panel B: LEfSe analysis in Candida expanders vs non-expanders post-IL17i (maintenance)

### Supplementary Figure 08:
### Panel A: LEfSe analysis in Candida albicans expanders vs non-expanders pre-IL17i
### Panel B: LEfSe analysis in Candida albicans expanders vs non-expanders post-IL17i (maintenance)
...
### Analysis was performed using LEfSe v1.0.7 at IL-17i pre and IL-17i maintenance visits.
### Comparison was made between subjects who demonstrated high expansion of Candida or C. albicans 
### versus those who demonstrated no expansion, mild/modest expansion or contraction.
...
### FDR significance was calculated using group_significance.py command in QIIME v1.9.1 via Kruksal-Wallis (B panels).
...
## Plotting - Candida baseline visit ##
...
## Plotting - Candida maintenance visit ##
...
## Plotting - Candida albicans baseline visit ##
...
## Plotting - Candida albicans maintenance visit ##
