...
### Brief description:
### This script covers the code for Supplementary Figure 01.

### Panel A: Taxa summary, order level
...
# Input file included taxa at the genus level.
...
# FDR significance calculated using group_significance.py command in QIIME v1.9.1 via Kruksal-Wallis
...
# Remainder of columns: relative abundance across samples for each taxa identified as significant by LEfSe analysis
